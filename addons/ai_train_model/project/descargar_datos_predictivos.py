...
def guardar_datos_csv(data, output_file):
    ...
    Args:
        data: Lista de diccionarios con los datos o DataFrame de pandas
        output_file: Ruta del archivo CSV donde guardar los datos
    """
    try:
        if isinstance(data, pd.DataFrame):
            # Si es un DataFrame, guardarlo directamente
